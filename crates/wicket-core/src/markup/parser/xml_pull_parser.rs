...
use wicket_util::collections::io::fully_buffered_reader::{FullyBufferedReader, ParseException};
use wicket_util::parse::metapattern::core::{XML_DECL, XML_ENCODING};
use wicket_util::string::strings::unescape_markup;

use crate::markup::parser::xml_tag::AttrValue;
use crate::markup::parser::xml_tag::XmlString;
...
mod test {
    ...
    use crate::markup::parser::xml_pull_parser::XmlPullParser;
